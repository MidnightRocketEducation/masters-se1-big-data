...
```zsh
curl -X POST "http://world-clock-test-producer-svc:8080/api/v1/world-clock-producer/change-time-speed?one-hour-equals=<milliseconds>"
```
...
curl -X POST \
  ...
  -d "\"2009-01-01T00:00:00Z\"" \
  http://world-clock-test-producer-svc:8080/api/v1/world-clock-producer/change-current-time
```
